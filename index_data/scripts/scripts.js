...
function alphaMapLoad() {
  ...
  document.getElementById("alphaMap2").classList.remove("activet");
  document.getElementById("origoMap").classList.remove("activet");
  document.getElementById("applySettings").style.display = "block";
  selectionSound();
};
function alphaMap2Load() {
  document.getElementById("alphaMap").classList.remove("activet");
  document.getElementById("alphaMap2").classList.add("activet");
  document.getElementById("origoMap").classList.remove("activet");
  document.getElementById("applySettings").style.display = "block";
  selectionSound();
};
...
function boardBGloader() {
  if(localStorage.getItem("boardStyle") === "imgAlpha") {
    ...
    document.getElementById("playBoardId").classList.remove("alpha2");
...
function applySettings() {
  ...
  if(document.getElementById("alphaMap2").className === "select activet") {
